...
## Histórico anterior à primeira release

As entradas abaixo preservam o histórico de desenvolvimento do fluxo anterior.
Descrevem o comportamento na época e não representam versões publicadas.
O fluxo atual usa Jujutsu, integração direta na main e releases por versão.
